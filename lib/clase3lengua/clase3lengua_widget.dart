...
class Clase3lenguaWidget extends StatefulWidget {
  const Clase3lenguaWidget({Key? key}) : super(key: key);

  @override
  _Clase3lenguaWidgetState createState() => _Clase3lenguaWidgetState();
}

class _Clase3lenguaWidgetState extends State<Clase3lenguaWidget> {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Image.asset(
                  'assets/images/obras_literarias.jpg',
