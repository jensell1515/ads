...
class Clase3quimicaWidget extends StatefulWidget {
  const Clase3quimicaWidget({Key? key}) : super(key: key);

  @override
  _Clase3quimicaWidgetState createState() => _Clase3quimicaWidgetState();
}

class _Clase3quimicaWidgetState extends State<Clase3quimicaWidget> {
