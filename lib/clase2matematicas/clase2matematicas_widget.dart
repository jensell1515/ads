...
class Clase2matematicasWidget extends StatefulWidget {
  const Clase2matematicasWidget({Key? key}) : super(key: key);

  @override
  _Clase2matematicasWidgetState createState() =>
      _Clase2matematicasWidgetState();
}

class _Clase2matematicasWidgetState extends State<Clase2matematicasWidget> {
