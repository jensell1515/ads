...
class CursodelenguaWidget extends StatefulWidget {
  const CursodelenguaWidget({Key? key}) : super(key: key);

  @override
  _CursodelenguaWidgetState createState() => _CursodelenguaWidgetState();
}

class _CursodelenguaWidgetState extends State<CursodelenguaWidget> {
