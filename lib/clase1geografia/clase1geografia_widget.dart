...
class Clase1geografiaWidget extends StatefulWidget {
  const Clase1geografiaWidget({Key? key}) : super(key: key);

  @override
  _Clase1geografiaWidgetState createState() => _Clase1geografiaWidgetState();
}

class _Clase1geografiaWidgetState extends State<Clase1geografiaWidget> {
