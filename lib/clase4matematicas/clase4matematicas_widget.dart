...
class Clase4matematicasWidget extends StatefulWidget {
  const Clase4matematicasWidget({Key? key}) : super(key: key);

  @override
  _Clase4matematicasWidgetState createState() =>
      _Clase4matematicasWidgetState();
}

class _Clase4matematicasWidgetState extends State<Clase4matematicasWidget> {
