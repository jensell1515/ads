...
class Clase1matematicaWidget extends StatefulWidget {
  const Clase1matematicaWidget({Key? key}) : super(key: key);

  @override
  _Clase1matematicaWidgetState createState() => _Clase1matematicaWidgetState();
}

class _Clase1matematicaWidgetState extends State<Clase1matematicaWidget> {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Image.asset(
                  'assets/images/operaciones_basicas.jfif',
