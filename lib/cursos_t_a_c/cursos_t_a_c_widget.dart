...
class CursosTACWidget extends StatefulWidget {
  const CursosTACWidget({Key? key}) : super(key: key);

  @override
  _CursosTACWidgetState createState() => _CursosTACWidgetState();
}

class _CursosTACWidgetState extends State<CursosTACWidget> {
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHByb2ZpbGV8ZW58MHx8MHx8&auto=format&fit=crop&w=900&q=60',
                                  width: 36,
                                  height: 36,
                                  fit: BoxFit.cover,
                                ),
