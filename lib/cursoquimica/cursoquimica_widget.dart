...
class CursoquimicaWidget extends StatefulWidget {
  const CursoquimicaWidget({Key? key}) : super(key: key);

  @override
  _CursoquimicaWidgetState createState() => _CursoquimicaWidgetState();
}

class _CursoquimicaWidgetState extends State<CursoquimicaWidget> {
