...
class Clase2AEPWidget extends StatefulWidget {
  const Clase2AEPWidget({Key? key}) : super(key: key);

  @override
  _Clase2AEPWidgetState createState() => _Clase2AEPWidgetState();
}

class _Clase2AEPWidgetState extends State<Clase2AEPWidget> {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Image.asset(
                  'assets/images/trabajo_en_equipo.jpg',
