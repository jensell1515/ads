...
class Clase2lenguaWidget extends StatefulWidget {
  const Clase2lenguaWidget({Key? key}) : super(key: key);

  @override
  _Clase2lenguaWidgetState createState() => _Clase2lenguaWidgetState();
}

class _Clase2lenguaWidgetState extends State<Clase2lenguaWidget> {
