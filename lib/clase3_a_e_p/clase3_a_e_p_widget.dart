...
class Clase3AEPWidget extends StatefulWidget {
  const Clase3AEPWidget({Key? key}) : super(key: key);

  @override
  _Clase3AEPWidgetState createState() => _Clase3AEPWidgetState();
}

class _Clase3AEPWidgetState extends State<Clase3AEPWidget> {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Image.asset(
                  'assets/images/sistema_de_ahorro.jfif',
