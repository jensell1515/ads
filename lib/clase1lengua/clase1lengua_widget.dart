...
class Clase1lenguaWidget extends StatefulWidget {
  const Clase1lenguaWidget({Key? key}) : super(key: key);

  @override
  _Clase1lenguaWidgetState createState() => _Clase1lenguaWidgetState();
}

class _Clase1lenguaWidgetState extends State<Clase1lenguaWidget> {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Image.asset(
                  'assets/images/generos-literarios.png',
