...
class Clase4geografiaWidget extends StatefulWidget {
  const Clase4geografiaWidget({Key? key}) : super(key: key);

  @override
  _Clase4geografiaWidgetState createState() => _Clase4geografiaWidgetState();
}

class _Clase4geografiaWidgetState extends State<Clase4geografiaWidget> {
