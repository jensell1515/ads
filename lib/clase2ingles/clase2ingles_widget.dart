...
class Clase2inglesWidget extends StatefulWidget {
  const Clase2inglesWidget({Key? key}) : super(key: key);

  @override
  _Clase2inglesWidgetState createState() => _Clase2inglesWidgetState();
}

class _Clase2inglesWidgetState extends State<Clase2inglesWidget> {
